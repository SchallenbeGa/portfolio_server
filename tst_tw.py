...
consumer_key = 'nGZ2GOUnmJheVWj5ZagsdHDKG'
consumer_secret = 'Yc7iFcuDFlNxQtFLEbEapIduSsN7OUO9aWaH931VwRdOGjFjgy'
access_token = '1265285941624811520-yCEcjINAvSFWmHLCFcqHfHSQPKplJZ'
access_token_secret = 'NkvqRUgBuhX9xSAjCDWQWP2j2EHO3S640KOIxDgCaVuGC'
...
def twet_graph():
    ...
    status = api.update_status_with_media("okay","tweettest.png")
twet_graph()